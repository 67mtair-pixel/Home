...
export default function PageHero({ title, description, breadcrumbs }: PageHeroProps) {
  return (
    <section className="relative bg-gradient-to-bl from-primary-900 via-primary-800 to-primary-600 pt-40 md:pt-44 pb-16 overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        {description && (
          <p className="text-lg text-primary-100 max-w-2xl animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            {description}
          </p>
        )}
      </div>
