      ...
      <div className="container-custom relative z-10">
        ...
        >
          {visionItems.map((item, i) => (
            ...
            >
              <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-b from-accent-500/5 to-transparent" />
              <span className="relative inline-flex items-center justify-center w-12 h-12 rounded-xl bg-white/[0.08] text-accent-400 mb-3 group-hover:bg-accent-500/20 group-hover:text-accent-300 transition-all duration-300 group-hover:scale-110">
                {item.icon}
              </span>
