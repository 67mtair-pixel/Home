    ...
    <section className="section-padding bg-primary-50 relative overflow-hidden">
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-block bg-gradient-to-r from-primary-600 to-primary-700 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 shadow-sm">
              الذراع الإنساني
            </span>
            ...
            <ul className="space-y-4 mb-8">
              {reliefFeatures.map((f, i) => (
                <li key={i} className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 text-primary-600 shadow-sm">
                    {f.icon}
                  </span>
            ...
            <Link
              to="/services/aid"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
            >
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 rounded-3xl p-8 text-white shadow-xl">
              <div className="text-center mb-8">
                <HandHeart className="w-16 h-16 mx-auto mb-4 text-accent-400" />
                <h3 className="text-xl font-bold mb-2">دورة الإغاثة الرقمية</h3>
                <p className="text-sm text-blue-200">نموذج مبتكر يخدم الجميع</p>
              </div>
