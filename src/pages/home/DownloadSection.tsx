...
export default function DownloadSection() {
  ...
  return (
    <section id="download" className="section-padding bg-gradient-to-bl from-primary-900 to-primary-800 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#" className="flex items-center gap-3 bg-white hover:bg-gray-50 rounded-xl px-6 py-3.5 transition-colors group">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-64 h-[500px] bg-gradient-to-b from-primary-700 to-primary-600 rounded-[3rem] border-4 border-white/20 shadow-2xl flex items-center justify-center">
                <div className="text-center">
                  <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <Smartphone className="w-10 h-10 text-white" />
                  </div>
                  <p className="text-white font-bold text-lg mb-1">وفرة</p>
                  <p className="text-primary-200 text-xs">Super App</p>
                  <div className="mt-6">
                    <Download className="w-6 h-6 text-accent-500 mx-auto animate-bounce" />
                  </div>
                </div>
              </div>
